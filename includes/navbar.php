     ...
     <div class="text-dark d-flex">
         <div class="me-auto">
             <span class="small"> Follow me:
                 ...
                 <a class="px-2" href="https://github.com/vimpoli" target="_blank" rel="noopener noreferrer"></a><i style="color: #171515;" class="fab fa-github"></i></span>
         </div>
         <div class="ms-auto">
 ...
 <nav class="navbar navbar-expand-lg navbar-bg shadow-lg navbar-dark sticky-top container">
     <a href="<?= base_url('') ?>" class="navbar-brand ps-2">BHIMOLI</a>
